...
public class GameController : MonoBehaviour
{
    ...
    //Global warming system values
    public float warmthIncPerSec;
    public float startingWarmth;
    private float warmth;
    private float baseWarmth;
    private float artificialWarmth;  //Artificial warmth is the warmth generated by user actions such as processing coal or explosions
    ...
    public int numEnemyPrefabs; //need so we can initialize enemy list with correct size
    ...
    //Planet
    private Planet planet; //Current planet
    private Planet ppf; //Planet prefab
    ...
    void Start()
    {
        ...
        FindObjectOfType<AudioManager>().PlayMusic(0); //Plays early game theme
    ...
    void Update()
    {
        ...
        {
            //if this scene just got initialized
    ...
    {
        //Handles difficulty increase over time - will be changed later
    ...
    void spawnHandler()
    {
        //Spawns a random enemy from list of enemies if the cooldown is over
    ...
    void warmthHandler()
    {
        ...
        //Communicates with a different manager that handles the effects of global warming
        globalWarmingManager.SetGlobalWarming(warmth);

        //Changes the color of the atmosphere based on warmth
